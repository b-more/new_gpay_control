...
class BankNameResource extends Resource
{
    ...
    {
        return checkReadBankNamesPermission();
    }
        ...
        return $form
            ->schema([
                Forms\Components\TextInput::make('name')
                    ->required()
                    ->maxLength(255),
                Forms\Components\TextInput::make('clearing_center')
                    ->maxLength(255),
            ]);
    }
        ...
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('name')
                    ->searchable(),
                Tables\Columns\TextColumn::make('clearing_center')
                    ->searchable(),
            ...
            ->actions([
                Tables\Actions\EditAction::make()->visible(function (){
                    return checkUpdateBankNamesPermission();
                }),
            ])
            ->bulkActions([
                Tables\Actions\BulkActionGroup::make([
                    Tables\Actions\DeleteBulkAction::make()->visible(function (){
                        return checkDeleteBankNamesPermission();
                    }),
                ]),
            ]);
    }
